...
{
	public partial class PorosiaForm : Form
	{
		...
		public int TavolinaPerPorosiID { get; set; }
		public PorosiaForm()
		{
			InitializeComponent();
		}

		public PorosiaForm(int tavolinaPerPorosiID)
		{
			InitializeComponent();
			TavolinaPerPorosiID = tavolinaPerPorosiID;
			lblTavolinaID.Text = "Tavolina nr: " + TavolinaPerPorosiID.ToString();
		...
		private void PorosiaForm_MouseDown(object sender, MouseEventArgs e)
		{
		...
		private void PorosiaForm_Load(object sender, EventArgs e)
		{
